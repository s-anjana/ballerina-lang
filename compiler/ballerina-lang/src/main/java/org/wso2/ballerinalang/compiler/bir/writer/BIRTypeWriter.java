...
public class BIRTypeWriter implements TypeVisitor {
    ...
    public void visit(BErrorType bErrorType) {
        ...
        int pkgNameCPIndex = addStringCPEntry(bErrorType.tsymbol.pkgID.pkgName.value);
        ...
        int pkgIndex = cp.addCPEntry(new PackageCPEntry(orgCPIndex, pkgNameCPIndex, nameCPIndex, versionCPIndex));
    ...
    private void writeTypeId(BTypeIdSet.BTypeId bTypeId) {
        ...
        int pkgNameCPIndex = addStringCPEntry(bTypeId.packageID.pkgName.value);
    ...
    private void writePackageIndex(BTypeSymbol tsymbol) {
        ...
        int pkgNameCPIndex = addStringCPEntry(tsymbol.pkgID.pkgName.value);
